...
TOTAL_CHAMPS_NUM = TOTAL_LVL1_NUM + TOTAL_LVL2_NUM + TOTAL_LVL3_NUM + TOTAL_LVL4_NUM + TOTAL_LVL5_NUM


class Pool:
    def __init__(self):
        self.total = TOTAL_CHAMPS_NUM
        self.quantities = [
        ...
        # TODO: get all the other champions below to the array above
